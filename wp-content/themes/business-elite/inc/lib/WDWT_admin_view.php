  ...
  */
  public function text_preview($element, $context='option', $opt_val='', $meta=array()){
    ...
    <div class="font_preview_wrap" id="wdwt_wrap_<?php echo $element['name']; ?>">
      <label class="typagrphy_label" for="" style="font-size:18px;font-size: 20px;font-family: Segoe UI;"><?php echo __('Preview', "business-elite" ); ?></label>
    ...
    $filetype = (isset($element["filetype"]) && $element_filetype != '') ? $element["filetype"] : $this->params["upload_filetype"];  ?>
      ...
      <div class="wdwt_param" id="wdwt_wrap_<?php echo $element['name']; ?>">
        <div class="optioninput" id="upload_images">
          ...
          <input class="upload-button button" type="button" id="uploader_<?php echo $element['name']; ?>" value="<?php esc_attr_e('Upload Image', "business-elite"); ?>"/>
        </div>
      </div>
    <?php 
  }
    ...
    <div class="wdwt_param" id="wdwt_wrap_<?php echo $element['name']; ?>">
      <div class="wdwt_slide wdwt_slide_<?php echo $element['name']; ?> last_slide" id="wdwt_slide_<?php echo $element['name']; ?>_0">
        ...
        <div class="slide-from-base_url" style="margin-bottom:3%;">
          <div valign="middle"><h4><?php esc_html_e("Image URL","business-elite"); ?></h4></div>
          <div>
            <input type="text" id="<?php echo $element['name']; ?>_url_0" size="50" value="" class="upload image_links_group" >
            
            <input type="button" class="<?php echo $element['name']; ?>_update-image slide_but_up" id="<?php echo $element['name']; ?>_update-button_0" value="<?php esc_attr_e("Update image", "business-elite"); ?>">

            <input type="button" class="<?php echo $element['name']; ?>_remove-image slide_but_rem wdwt_btn_red" id="<?php echo $element['name']; ?>_remove-button_0" value="<?php esc_attr_e("Remove this slide", "business-elite"); ?>"  />
          </div>
        </div>
        <!-- Image -->
        ...
        <div class="slide-from-base_desc" style="margin-bottom:3%;">
          <div valign="middle">
            <h4><?php esc_html_e("Image Description", "business-elite"); ?></h4>
          </div>
          <div>
      ...
      <div class="slider-controls">
        <div valign="middle">
          <h4>
            <?php esc_html_e("Image", "business-elite"); ?>
            <span class="hasTip" style="cursor: pointer;color: #3B5998;" title="<?php esc_attr_e("Add more than two images to the slider in PRO version.","business-elite"); ?>">[?]</span>
          </h4>
        </div>
        <div>
          ...
          <input class="upload_button_slide" type="button" id="<?php echo $element['name']; ?>_add-button" value="<?php esc_attr_e('Add new slide', "business-elite"); ?>" />
        </div>
      </div>
    </div>
    <script type="text/javascript">
    ...
    <div class="wdwt_param" id="wdwt_wrap_<?php echo $element['name']; ?>">
      ...
      <div class="wdwt_diagram wdwt_diagram_<?php echo $element['name']; ?> last_percent" id="wdwt_diagram_<?php echo $element['name']; ?>_0">
        ...
        <div class="diagram-from-base_title">
          <div  valign="middle">
            <h4><?php esc_html_e("Title", "business-elite"); ?></h4>
          </div>
        ...
        <div class="diagram-from-base_desc" style="margin-bottom:3%;">
          <div valign="middle">
            <h4><?php esc_html_e("Percent", "business-elite"); ?></h4>
          </div>
          <div>
            <input type="text" class="diagram_percent_group" id="<?php echo $element['name']; ?>_percent_0"  value="" />% 
            <input type="button" class="<?php echo $element['name']; ?>_remove-percent wdwt_btn_red" id="<?php echo $element['name']; ?>_remove-button_0" value="<?php esc_attr_e("Remove this percent", "business-elite"); ?>"  />
          </div>
        </div>
      </div>
      ...
      <div class="diagram-controls">
        <div>
          ...
          <input class="add_percent wdwt_btn_blue" type="button" id="<?php echo $element['name']; ?>_add-button" value="<?php esc_attr_e('Add new percent value', "business-elite"); ?>" />
        </div>
      </div>
    </div>
    <script type="text/javascript">
