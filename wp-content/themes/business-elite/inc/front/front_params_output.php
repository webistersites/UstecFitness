...
#slideshow .bwg_slideshow_description_text *{
	color: <?php echo $slider_desc_color;?> !important;
}
...
.sticky_post { border: 5px double <?php echo $text_headers_color; ?>; }
	...
	*/
    ...
    <style>
		...
		.phone .content-posts-container .content-post {
			display: inline-block;
			float:none !important;
		}
		.phone .content-posts-container{
			text-align: center;
		}
    ...
    .tablet .content-posts-container .content-post,
    .phone .content-posts-container .content-post{
